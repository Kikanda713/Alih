...
const dict = {
  fr: {
    ...
    // Back-office admin
    'profile.admin': 'Back-office',
    'admin.badge': 'Back-office',
    'admin.nav.overview': "Vue d'ensemble",
    'admin.nav.users': 'Utilisateurs',
    'admin.denied.title': 'Accès réservé',
    'admin.denied.text': 'Ce back-office est réservé aux administrateurs Tindisa.',
    'admin.denied.cta': 'Aller à mon tableau de bord',
    'admin.home.title': 'Back-office Tindisa',
    'admin.home.subtitle': "Vue d'ensemble et gestion des utilisateurs de la plateforme.",
    'admin.home.manageUsers': 'Gérer les utilisateurs',
    'admin.stats.users': 'Utilisateurs',
    'admin.stats.merchants': 'Commerçants',
    'admin.stats.buyers': 'Acheteurs',
    'admin.stats.pending': 'Comptes invités',
    'admin.users.title': 'Utilisateurs',
    'admin.users.subtitle': 'Commerçants et acheteurs de la plateforme.',
    'admin.users.all': 'Tous',
    'admin.users.merchants': 'Commerçants',
    'admin.users.buyers': 'Acheteurs',
    'admin.users.search': 'Rechercher (nom, email, téléphone)…',
    'admin.users.empty.title': 'Aucun utilisateur',
    'admin.users.empty.text': 'Aucun utilisateur ne correspond à ce filtre.',
    ...
    'admin.users.suspended': 'Utilisateur suspendu.',
    'admin.users.activated': 'Utilisateur réactivé.',
    'admin.users.confirm': 'Confirmer cette action pour « {name} » ?',
    'admin.type.merchant': 'Commerçant',
    'admin.type.buyer': 'Acheteur',
    'admin.type.both': 'Mixte',
    'admin.status.active': 'Actif',
    'admin.status.suspended': 'Suspendu',
    'admin.status.guest': 'Invité',

    // Abonnement (marchand)
    'dash.nav.subscription': 'Abonnement',
    'sub.title': 'Mon abonnement',
    'sub.subtitle': 'Choisissez la formule adaptée à votre activité. Pour vos clients, acheter reste gratuit.',
    'sub.current': 'Formule actuelle',
    'sub.status.trialing': 'Essai en cours',
    'sub.status.active': 'Actif',
    'sub.status.cancelled': 'Résilié',
    'sub.status.expired': 'Expiré',
    'sub.trialEnds': "Essai gratuit jusqu'au {date}",
    'sub.renews': 'Renouvellement le {date}',
    'sub.cancel': 'Résilier',
    'sub.cancelConfirm': "Résilier votre abonnement ? Il reste actif jusqu'à la fin de la période en cours.",
    'sub.popular': 'Populaire',
    'sub.month': 'mois',
    'sub.trial': "1 mois d'essai gratuit",
    'sub.currentPlan': 'Formule actuelle',
    'sub.subscribe': 'Souscrire',
    'sub.tryFree': 'Essayer 1 mois gratuit',
    'sub.switch': 'Choisir cette formule',
    'sub.note': 'Sans engagement, résiliable à tout moment. Paiement par Mobile Money ou cash.',
    ...
    'admin.subs.subtitle': 'Les abonnements des vendeurs de la plateforme.',
    'admin.subs.empty.title': 'Aucun abonnement',
    'admin.subs.empty.text': 'Aucun vendeur abonné pour le moment.',
    'admin.subs.col.user': 'Vendeur',
    'admin.subs.col.plan': 'Formule',
    'admin.subs.col.price': 'Prix',
    'admin.subs.col.status': 'Statut',
    'admin.subs.col.period': 'Échéance',
  },
